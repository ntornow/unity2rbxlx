...
- Skeletal animation supported for R15-mappable rigs (Motor6D + `animator_runtime.luau`); binary `.anim` / `.controller` files are not yet parsed (text-YAML works). See `converter/docs/UNSUPPORTED.md` for the full list.
